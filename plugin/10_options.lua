...
opt.iskeyword = '@,48-57,_,192-255,-' -- 将-也视为word一部分

opt.formatlistpat = [[^\s*[0-9\-\+\*]\+[\.\)]*\s\+]] -- 识别数字开头列表，对应'formatoptions'的n
